 ...
 * $document, $doc, $all, $third-party, $3p, $popup, $script, $image
 *
...
function removeModifiers(rules) {
    ...
    rules.forEach((rawRuleText) => {
        ...
        modified = ruleUtils.removeModifier(props, 'script') || modified;
        modified = ruleUtils.removeModifier(props, 'image') || modified;
